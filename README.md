...
- **Deployment** – REST API; modular ML pipeline; dataset and Jupyter notebooks in backend
...
backend/          # FastAPI app, validation, ML inference
  ...
  data/           # Dataset (CSV); generated by train_model or notebooks
  notebooks/      # Jupyter notebooks (EDA, training, inference demo)
